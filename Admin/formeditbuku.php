                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
						...
						<form class="user" action="proseseditbuku.php" method="POST">
								...
								<select name="kategori"  class="form-element" id="kategori" selected="<?php echo $data['kategori']; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name = "penulis" class="form-control form-control-user"
                                        id="penulis" placeholder="Penulis" value="<?php echo $data['penulis']; ?>">
                                    
                                </div>
								<div class="form-group">
                                    
                                    <input type="text" name = "penerbit" class="form-control form-control-user"
                                        id="Penerbit" placeholder="Penerbit" value="<?php echo $data['penerbit']; ?>">
                                    
                                </div>
								<div class="form-group">
                                    
                                    <input type="number" name = "tahun" min="0" max="2022" class="form-control form-control-user"
                                        id="tahun" placeholder="tahun" value="<?php echo $data['tahun']; ?>">
                                    
                                </div>
                                
                                &ensp;
                                &ensp;
                                <button class="btn btn-primary btn-user btn-block" name="edit" value ="edit">Ubah data buku</button>
                                <hr>
                            </form>
					</div>
