            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
						...
						<div class="col-lg-7">
						<form class="user" action="prosestambahstaff.php" method="POST">
                                ...
                                <div class="col-sm-20 ml-4">
                                    ...
                                    <select name="role"  selected="user">
                                ...
                                &ensp;
                                &ensp;
                                <button class="btn btn-primary btn-user btn-block" name="tambah" value ="tambah">Daftarkan Akun</button>
                                <hr>
                            </form>
					</div>
