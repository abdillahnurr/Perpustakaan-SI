...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Daftarkan Akun</h6>
                        </div>
						<div class="col-lg-7">
						<?php
	...
	$show = mysqli_query($connection,"SELECT * FROM akun WHERE idlogin='$id'");
	...
	?>
						<form class="user" action="proseseditstaff.php" method="POST">
								<div class="form-group mt-3">
                                    <input type="text" name = "nama" class="form-control form-control-user" id="nama" autocomplete="off"
                                ...
                                <div class="form-group">
                                    <input type="number" size = "20" min="0" name = "idlogin" class="form-control form-control-user" id="nipdanim" autocomplete="off"
                                        placeholder="NIP / NIM Anda" value="<?php echo $data['idlogin']; ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <input type="email" name = "email" class="form-control form-control-user" id="email" autocomplete="off"
                                        placeholder="E-mail Anda" value="<?php echo $data['email']; ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <table>
                                    <tr>
                                    <td>
                                <div class="col-sm-20 ml-4">
									<label for="role">Role</label>
                                    <select name="role"  selected="<?php echo $data['role']; ?>">
                                    ...
                                    <td>
									<label class="ml-4" for="gender">Jenis Kelamin</label>
                                    <select class="form-select " name="gender"aria-label="Default select example" selected="<?php echo $data['gender']; ?>">
                                ...
                                &ensp;
                                &ensp;
                                <button class="btn btn-primary btn-user btn-block" name="ubah" value ="ubah">Ubah data akun</button>
                                <hr>
                            </form>
					</div>
